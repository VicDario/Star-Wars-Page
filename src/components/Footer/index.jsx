...
function Footer() {
  return (
    <footer className="d-flex justify-content-around aling-content-center px-5">
      <div className="ps-2">
        <a className="link" href="https://github.com/VicDario" target="_blank" rel="noreferrer">
          <FontAwesomeIcon className="social-icon" icon={faGithubSquare} />
        </a>
        <a className="link" href="https://twitter.com/VicDariof" target="_blank" rel="noreferrer">
