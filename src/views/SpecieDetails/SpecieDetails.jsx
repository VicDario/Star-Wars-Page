          ...
          <div className="col-md-6 col-sm-12 details pt-4">
            ...
            <ul className="list-details text-white text-capitalize ">
              <li className="d-flex justify-content-between">
                ...
                <span>{specie.data.result.properties.classification}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Designation:</span>
                <span>{specie.data.result.properties.designation}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Average height:</span>
                <span>{specie.data.result.properties.average_height}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Average lifespan:</span>
                <span>{specie.data.result.properties.average_lifespan}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Hair colors:</span>
                <span>{specie.data.result.properties.hair_colors}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Eye colors:</span>
                <span>{specie.data.result.properties.eye_colors}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Language:</span>
                <span>{specie.data.result.properties.language}</span>
              </li>
              <li className="d-flex justify-content-between">
                ...
                {specie.planet ? (
                  <Link
                    className="text-info"
                    to={`/planets/${specie.planet.result.properties.name
                      .split(' ')
                      .join('')
                      .toLowerCase()}/${specie.planet.result.uid}`}
                  >
