          ...
          <div className="col-md-6 col-sm-12 details pt-4">
            ...
            <ul className="list-details text-white text-capitalize ">
              <li className="d-flex justify-content-between">
                <span>Diameter:</span>
                <span>{planet.result.properties.diameter}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Rotation period:</span>
                <span>{planet.result.properties.rotation_period}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Orbital period:</span>
                <span>{planet.result.properties.orbital_period}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Gravity:</span>
                <span>{planet.result.properties.gravity}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Population:</span>
                <span>{planet.result.properties.population}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Climate:</span>
                <span>{planet.result.properties.climate}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Terrain:</span>
                <span>{planet.result.properties.terrain}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Surface water:</span>
                <span>{planet.result.properties.surface_water}</span>
              </li>
            </ul>
