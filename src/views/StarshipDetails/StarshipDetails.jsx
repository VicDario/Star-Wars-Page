          ...
          <div className="col-md-6 col-sm-12 details pt-4">
            ...
            <ul className="list-details text-white text-capitalize ">
              <li className="d-flex justify-content-between">
                <span>Model:</span>
                <span>{starship.result.properties.model}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Starship class:</span>
                <span>{starship.result.properties.starship_class}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Manufacturer:</span>
                <span>{starship.result.properties.manufacturer}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Cost in credits:</span>
                <span>{starship.result.properties.cost_in_credits}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Length:</span>
                <span>{starship.result.properties.length}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Crew:</span>
                <span>{starship.result.properties.crew}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Passengers:</span>
                <span>{starship.result.properties.passengers}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Max atmosphering speed:</span>
                <span>{starship.result.properties.max_atmosphering_speed}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Hyperdrive rating:</span>
                <span>{starship.result.properties.hyperdrive_rating}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>MGLT:</span>
                <span>{starship.result.properties.MGLT}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Cargo capacity:</span>
                <span>{starship.result.properties.cargo_capacity}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Consumables:</span>
                <span>{starship.result.properties.consumables}</span>
              </li>
            </ul>
