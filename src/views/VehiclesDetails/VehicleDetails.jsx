          ...
          <div className="col-md-6 col-sm-12 details pt-4">
            ...
            <ul className="list-details text-white text-capitalize ">
              <li className="d-flex justify-content-between">
                <span>Model:</span>
                <span>{vehicle.result.properties.model}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>vehicle class:</span>
                <span>{vehicle.result.properties.vehicle_class}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Manufacturer:</span>
                <span>{vehicle.result.properties.manufacturer}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Cost in credits:</span>
                <span>{vehicle.result.properties.cost_in_credits}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Length:</span>
                <span>{vehicle.result.properties.length}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Crew:</span>
                <span>{vehicle.result.properties.crew}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Passengers:</span>
                <span>{vehicle.result.properties.passengers}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Max atmosphering speed:</span>
                <span>{vehicle.result.properties.max_atmosphering_speed}</span>
              </li>
              <li className="d-flex justify-content-between">
                <span>Consumables:</span>
                <span>{vehicle.result.properties.consumables}</span>
              </li>
            </ul>
